      ...
      body: Stack(
        children: [
          ...
          AnimatedPositioned(
            ...
            right: _isMenuOpen ? 0 : -MediaQuery.of(context).size.width / 2.5,
            top: 0,
            bottom: 0,
      ...
      bottomNavigationBar: Container(
        ...
        child: ClipRRect(
          ...
          child: BottomNavigationBar(
            ...
            backgroundColor: isDarkMode ? Color(0xFF1A2528) : Colors.white,
            selectedItemColor: isDarkMode ? Color(0xFF7EB2C4) : Color(0xFF5B8FB9),
